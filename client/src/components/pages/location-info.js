    ...
    <div className="location-container">
        ...
        <div>
            <div className="map-container">
                <iframe width="100%" height="100%" frameBorder="0" src={process.env.MAPS_URI || "https://www.google.com/maps/embed/v1/place?q=Ocean%20Place%20Resort%20and%20Spa&key=AIzaSyBT-P9AacF8Y3rLhx4M5LcnUV-f1yAOTZo"}></iframe>
            </div>
