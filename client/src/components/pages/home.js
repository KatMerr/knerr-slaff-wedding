...
export default () => (
    <div className="home-container">
        ...
        Thank you for visiting our website! We're happy to be able to celebrate this important occassion with our closest family and friends. To navigate the site, please use the navigation bar located above.
